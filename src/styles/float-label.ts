...
@Component({
    ...
    template: `
        <GridLayout rows="30, auto" marginBottom="5">
            <Label #label row="1" [attr.text]="placeholder" opacity="0.4" fontSize="14"  class="input fas"></Label>
            <TextField #textField [attr.secure]="secure" [disabled]="disabled" [(ngModel)]="value" row="1"  (focus)="onFocus()" (blur)="onBlur()" borderBottomWidth="3"  [attr.borderBottomColor]="borderBottomColor" padding="2" ></TextField>
        </GridLayout>
    `
})
